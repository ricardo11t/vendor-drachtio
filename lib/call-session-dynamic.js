...
// CRITICAL: rtpengine-client@0.4.12 requires port as FIRST parameter
// Signature: engine.offer(port, payload, callback)
// ============================================================
...
class CallSession extends Emitter {
  ...
  async connect() {
    try {
      ...
      // ========================================================
      this.logger.info({ sdpLength: this.req.body?.length || 0 }, '📝 Sending SDP to RtpEngine');
